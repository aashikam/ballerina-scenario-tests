...
public class PublisherSubscribeTest extends ScenarioTestBase {
    ...
    @Test(description = "Test RabbitMQ connector")
    public void testPublisherSubscribe() throws IOException {
        String url = "http://" + host + ":" + port + "/rabbitmq/test";
